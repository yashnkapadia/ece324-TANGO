...
- [x] **RES-01**: Max-Pressure action encoded as one-hot and appended to actor observation at each step
- [x] **RES-02**: Actor has binary override gate head (gate logit) alongside existing phase head
...
- [x] **RES-06**: Evaluation logs gate_fraction metric (fraction of steps where MAPPO overrides MP)
