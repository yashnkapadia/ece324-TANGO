...
\begin{figure}[!htbp]
  \centering
  \includegraphics[width=0.62\columnwidth]{asce_bar_chart.pdf}
...
\item {\bf Experiment Statistical Significance}
    \item[] Answer: \answerYes{}
    \item[] Justification: All headline results report mean $\pm$ std over 5 matched random seeds, and Table~\ref{tab:results} additionally reports two-sided paired $t$-test $p$-values against Max-Pressure for each scenario.
